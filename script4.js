...
$('document').ready(function(){
  console.log(user.lastIndexOf('Hey man'));
  $('#popShadow').hide(0);
...
function getDate(day){
  var dates = ['May 23, 2019', 'May 24, 2019','May 27, 2019','June 3, 2019','June 20, 2019','July 1, 2019','September 3, 2019','August 19, 2020'];
...
function endOfDay(){
  if (user[indexOfArray].length == 0 && comp[compWord].length == 0)
  {
    ...
    if(indexOfArray==130|| indexOfArray==6){
      userTurn=true;
    } else {
      userTurn =false;
    }
